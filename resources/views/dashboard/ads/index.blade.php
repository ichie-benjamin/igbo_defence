    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                ...
                <div class="p-1">
                    <Link class="bg-indigo-600 text-white rounded-md  px-4 py-2" modal  href="{{ route('ads.create') }}">Add New Ads
                    </Link>
                </div>
                ...
                <x-splade-table class="mt-5" :for="$data">
                    <x-splade-cell file as="$item">
                        @if($item->file)
                            <img height="50" width="50" src="{{ $item->file }}" />
                        @endif
                    </x-splade-cell>
...
{{--                        <Link class="text-green-600 hover:text-green-400 font-semibold" modal href="{{ route('versions.edit', $item) }}"> Edit </Link>--}}
                        ...
                        <Link
                            ...
                            confirm="Delete"
                            confirm-text="Are you sure you want to delete this ads?"
                            confirm-button="Delete"
                            cancel-button="Cancel"
                            href="{{ route('ads.destroy', $item->id) }}" method="DELETE">
                        Delete
                        </Link>
